...
onload = function () {
    ...
    add.onclick = function () {
        ...
        //contact number taken of length 6
        ...
        //setting to empty again
        contact_info.value = "";
    };

    //search using number and then delete
        ...
        inp.addEventListener("input", function (e) {
            ...
            for (let i = 0; i < Math.min(arr.length,6) ; i++) {
                ...
                item.addEventListener("click", function (e) {
                    ...
                    inp.value = "";
                    //close the list of autocompleted values or any other open lists of autocomplete values:
                    closeAllLists();
